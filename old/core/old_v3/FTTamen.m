classdef FTTamen < FTT
    ...
    methods
            ...
            while true % run ALS
                ...
                for k = ind
                    if obj.direction > 0
                        ...
                        [obj.cores{k}, obj.interp_x{k}, obj.res_w{k}, obj.res_x{k}, obj.cores{k+1}] = build_basis_amen(obj, ...
        ...
        function [core, interp_x, res_w, res_x, core_next] = build_basis_amen(obj, oned, ...
            ...
            rnew        = size(B,2);
            %
            [indf,core,interp_atx] = point_selection(oned, obj.opt.int_method, B);
            ...
            indr    = point_selection(oned, obj.opt.int_method, Qr);
